                                    ...
                                    [\Node{Obj}{NP}
                                        [\Node{Head}{Nom},edge={line width=1pt}
                                            [\Node{Head}{N},edge={line width=1pt}
                                                ...
                                                [\Node{Flat}{N}[Johansson]]]]]]]]]]]
            [\Node{Head}{VP},edge={line width=1pt}, before drawing tree={x+=4em}
                [\Node{Head}{GAP\idx{x}},edge={line width=1pt}, before drawing tree={x+=4em}[--, before drawing tree={x+=4em}]]
                [\Node{PredComp}{GAP\idx{y}}, before drawing tree={x+=4em}[--, before drawing tree={x+=4em}]]]]]]
\node at (current bounding box.south)[yshift=-1cm]{
(1) exclamatory-interrogative};
        \end{forest}
