...
% # text = I like from the waist up.
% # sent = I like from the waist up
% # note = uttered while having a photo taken
% # tree_by = nschneid
    ...
    [\Node{Head}{VP},edge={line width=1pt}
        [\Node{Head}{V},edge={line width=1pt}[like]]
        [\Node{Comp}{PP} \hlgreen{\Info}
            ...
            [\Node{Obj}{NP}
                ...
                [\Node{Head}{Nom},edge={line width=1pt}
                    [\Node{Head}{N},edge={line width=1pt}[waist]]]]
            [\Node{Comp}{PP}
                [\Node{Head}{P},edge={line width=1pt}[up,label={right:\p{.}}]]]]]]
\node at (current bounding box.south)[yshift=-1cm]{
(1) double-complement PP; cf. \textquotesingle{}from Boston to Providence\textquotesingle{}, p. 641. Also a spatial PP taking the place of an object in clause structure};
        \end{forest}
